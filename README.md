...
Pick a random step t and random noise ε.
Build x_t using the forward formula.
Ask the network to predict ε from x_t and t.
Loss = mean squared error between the true ε and the predicted ε.
Loss = ‖ ε − ε_θ(x_t, t) ‖²
